...
#*                                                +#+#+#+#+#+   +#+           *#
#*   Created: 2016/12/05 13:28:00 by agaspard          #+#    #+#             *#
#*   Updated: 2016/12/11 21:41:59 by jpicot           ###   ########.fr       *#
#*                                                                            *#
#* ************************************************************************** *#
...
clean:
	@make fclean -C $(D_LIB)
	@echo "$(LOG_RED)Deleting fillit's objs ✖$(LOG_NOCOLOR)"
	@$(RM) $(D_OBJ)

fclean: clean
	@echo "$(LOG_RED)Deleting fillit ✖$(LOG_NOCOLOR)"
	@$(RM) $(NAME)

re: fclean all

norme:
	@echo "$(LOG_YELLOW)Checking the norme of fillit...\
		$(LOG_WHITE) for each .c$(LOG_NOCOLOR)"
	@norminette $(D_SRC)/
	@echo "\n$(LOG_YELLOW)Checking the norme of fillit...\
